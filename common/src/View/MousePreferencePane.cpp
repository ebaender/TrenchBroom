...
namespace TrenchBroom {
    namespace View {
        ...
        void MousePreferencePane::createGui() {
            ...
            m_flyMoveSpeedSlider = new SliderWithLabel(0, 512);
        ...
        void MousePreferencePane::doUpdateControls() {
            ...
            m_flyMoveSpeedSlider->setRatio(pref(Preferences::CameraFlyMoveSpeed) / 2.0f);
        }
        ...
        void MousePreferencePane::flyMoveSpeedChanged(const int /* value */) {
            const auto ratio = 2.0f * m_flyMoveSpeedSlider->ratio();
            PreferenceManager& prefs = PreferenceManager::instance();
